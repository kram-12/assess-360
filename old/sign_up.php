...
if (isset($_POST['studsu'])) {
    ...
    if (isset($_POST['name1']) && isset($_POST['reg1']) && isset($_POST['email1']) && isset($_POST['phno1']) && isset($_POST['dept1']) && isset($_POST['dob1']) && isset($_POST['gender1']) && isset($_POST['password1']) && isset($_POST['cpassword1'])) {
        ...
        if ($password1 == $cpassword1) {
            $sql = "insert into student (reg_no,name,email,ph_no,dept,gender,dob) values('$reg1','$name1','$email1','$phno1','$dept1','$gender1','$dob1')";
            if (mysqli_query($conn, $sql)) {
                $sql2 = "insert into members(member_type,email,password)values('Student','$email1','$password1');";
...
require 'sql.php';
        ...
        if ($password2 == $cpassword2) {
            $sql = "insert into faculty (faculty_id,name,email,ph_no,dept,gender,dob) values('$usn2','$name2','$mail2','$phno2','$dept2','$gender2','$dob2')";
            if (mysqli_query($conn, $sql)) {
                $sql2 = "insert into members(member_type,email,password)values('Faculty','$mail2','$password2');";
                if (mysqli_query($conn, $sql2)) {
                echo "<script>
                alert('Successfully Signed Up!');
                window.location.replace(\"index.php\");</script>";
