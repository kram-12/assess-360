  ...
  <body>
    ...
    <div class="l-form">
      ...
      <div class="form">
        ...
        <form action="send-password-reset.php" class="form__content" method="POST">
          ...
          <br>
          <center><input type="submit" class="form__button" name ="submit" value="Get Code"></center>
          <div class="form__signup">
            <button onclick="location.href='signup.php'" type="button" class="form__button">Sign Up</button>
            <button onclick="location.href='index.php'" type="button" class="form__button">Cancel</button>
          </div>
        </form>
      </div>
    </div>
